...
import { addToCart, removeFromCart,removeFromCartAll } from "../actions/cartAction";
  ...
  return (
    ...
    >
      ...
      <Modal.Body>
        ...
        <p>
          Your order will be delivered within a few business days.
        </p>
      </Modal.Body>
      <Modal.Footer>
      ...
      <Col md={4}>
        <Card>
          <ListGroup variant="flush">
            ...
            <ListGroup.Item>
            <i className="m-1 fas fa-money "></i>Cash on Delivery
              <Button
                type="button"
                className="btn-block"
